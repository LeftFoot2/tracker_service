...
init(Req0, Opts) ->
        {ok,Data,_} = cowboy_req:read_body(Req0),
                ...
                Result = erpc:call("deliveryman@bl.thomasjamiesonprograms.com", business_logic, package_transfer_url_handler, [Package_ID,Location_ID]), %get_friends_server:get_friends_of(Package_ID) of
